{{-- resources/views/components/ai-assistant-mini.blade.php --}}
@props(['case' => null])

<div class="ai-assistant-mini" x-data="aiMiniAssistant()" x-init="init()">
    <!-- Ask AI Button -->
    <button @click="toggleChat" 
            class="w-full mt-3 bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-lg text-sm transition-colors flex items-center justify-center">
        <i class="fas fa-robot mr-2"></i>
        <span x-text="status.running ? 'Ask AI' : 'AI Offline'"></span>
    </button>

    <!-- AI Chat Window (same as before but positioned differently) -->
    <div x-show="isOpen" 
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 w-full max-w-2xl"
             style="height: 80vh;">
            
            <!-- Header -->
            <div class="bg-gradient-to-r from-blue-600 to-purple-600 p-4 rounded-t-xl flex items-center justify-between">
            ...
            <!-- Messages Container -->
            <div class="flex-1 p-4 overflow-y-auto h-[calc(80vh-180px)]" id="aiMessages">
